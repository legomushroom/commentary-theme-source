...
if(function_exists("register_field_group"))
{
  ...
  register_field_group(array (
    ...
    'fields' => array (
      ...
      array (
        'key' => 'field_540004d5673c1',
        'label' => 'Disable Breaking News',
        'name' => 'vw_post_breaking_less',
        'type' => 'true_false',
        'instructions' => 'Remove breaking news block at top',
        'message' => '',
        'default_value' => 0,
      ),
      array (
        'key' => 'field_540004d5673c5',
        'label' => 'Post Views Forgery (Explicit)',
        'name' => 'vw_post_views_forgery_explicit',
        'type' => 'text',
        'instructions' => 'Enter the number to add to real number of post views for this post',
        'message' => '',
        'default_value' => 0,
      ),
      array (
        'key' => 'field_540004d5673c7',
        'label' => 'Post Shares Forgery (Explicit)',
        'name' => 'vw_post_shares_forgery_explicit',
        'type' => 'text',
        'instructions' => 'Enter the number to add to real number of post shares for this post',
        'message' => '',
        'default_value' => 0,
      ),
      array (
