    ...
    <iframe name="print_frame" width="0" height="0" style="width: 0; height: 0;" frameborder="0" src="/commentary/print-page/" id="js-print-iframe" onload="window.CommentaryMagazine = (window.CommentaryMagazine == null) ? {} : window.CommentaryMagazine; window.CommentaryMagazine.isIframeLoaded = true; jQuery(document).trigger('vw-iframe-loaded')"></iframe>
